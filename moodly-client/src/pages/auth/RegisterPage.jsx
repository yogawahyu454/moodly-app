...
export default function RegisterPage() {
    ...
    return (
      ...
      ================================================================
      */}
            {/* --- PERBAIKAN 1: className harus pakai "" --- */}
            ...
            <main className="flex-grow flex flex-col justify-center p-8">
                <div className="w-full">
                            ...
                            <>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        style={{
                                            // --- PERBAIKAN 2: backgroundImage harus pakai '' ---
                                            backgroundImage:
                            ...
                            <>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        style={{
                                            // --- PERBAIKAN 3: backgroundImage harus pakai '' ---
                                            backgroundImage:
                                                "url(\"data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%236b7280' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e\")",
                                            backgroundPosition:
                                                "right 0.75rem center",
                    ...
                    <div className="text-center text-sm text-gray-600 mt-4">
                        Sudah punya akun?{" "}
                        <Link
                            // Arah link disesuaikan dengan role
